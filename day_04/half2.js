	...
	pairs.forEach((pair) => {
		...
		if (
			(parseInt(rangeEnds[0]) >= parseInt(rangeEnds[2]) &&
				parseInt(rangeEnds[0]) <= parseInt(rangeEnds[3])) ||
			(parseInt(rangeEnds[1]) >= parseInt(rangeEnds[2]) &&
				parseInt(rangeEnds[1]) <= parseInt(rangeEnds[3])) ||
			(parseInt(rangeEnds[2]) >= parseInt(rangeEnds[0]) &&
				parseInt(rangeEnds[2]) <= parseInt(rangeEnds[1])) ||
			(parseInt(rangeEnds[3]) >= parseInt(rangeEnds[0]) &&
				parseInt(rangeEnds[3]) <= parseInt(rangeEnds[1]))
		) {
